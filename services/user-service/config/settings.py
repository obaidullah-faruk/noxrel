...
# sparse metrics flap between their real value and 0. Setting this env var before
# any metric is created makes prometheus_client write per-process files into the
# dir, which the /metrics view aggregates across all workers. Single-process
# commands (manage.py, pytest) leave the var unset and run normally.
...
MIDDLEWARE = [
    ...
    "core.metrics.PlatformMetricsMiddleware",
